...
import { FaUser, FaPhone, FaMapMarkerAlt, FaCamera, FaHome, FaShoppingBag, FaSpinner, FaCheck, FaTimes } from 'react-icons/fa';
        ...
        <div className="profile-content">
              ...
              <div className="profile-image-container">
                <img
                  ...
                  onError={(e) => {
                    ...
                    if (!e.target.parentNode.querySelector('.profile-image-placeholder')) {
          ...
          <form onSubmit={handleSubmit} className="profile-form">
            ...
            <div className="form-actions">
              <button type="submit" className="update-button" disabled={status.loading}>
                {status.loading ? (
                  <>
